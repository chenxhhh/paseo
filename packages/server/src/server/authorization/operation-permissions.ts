...
const INBOUND_PERMISSION = {
  ...
  // Coordination tasks: reading pending work is workspace-level, resolving a
  // gate or answering a question changes what an agent does next.
  "task/answer-question": "workspace.write",
  "task/inspect": "workspace.read",
  "task/list": "workspace.read",
  "task/questions": "workspace.read",
  "task/resolve-gate": "workspace.write",
  ...
  "workspace.user-status.set.request": "workspace.manage",
...
const OUTBOUND_PERMISSION = {
  ...
  "task/answer-question/response": "workspace.write",
  "task/inspect/response": "workspace.read",
  "task/list/response": "workspace.read",
  "task/questions/response": "workspace.read",
  "task/resolve-gate/response": "workspace.write",
  ...
  "workspace.user-status.set.response": "workspace.manage",
